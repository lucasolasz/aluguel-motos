    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto md:max-w-200">
        ...
        <div className="text-sm text-muted-foreground space-y-4">
          <p>
            As cláusulas e condições do contrato de aluguel de carros e seguro estão à sua disposição nas agências Localiza ou clicando aqui.
          </p>
          <p>
            O CLIENTE declara e reconhece que a Localiza Rent a Car S.A. e demais empresas do grupo, por meio da QI Sociedade de Crédito Direto S.A., instituição financeira inscrita no CNPJ sob o nº 32.402.502/0001-35, poderá, para fins de análise de crédito, realizar a consulta de suas informações constantes no Sistema de Informações de Crédito do Banco Central do Brasil (&ldquo;SCR&rdquo;) e nos Órgãos de Proteção ao Crédito e revelar a terceiros. Mais informações sobre o SCR podem ser obtidas em consulta ao ambiente virtual do Banco Central (www.bcb.gov.br).
          </p>
          <p>
            Para retirar o veículo você precisa ter idade mínima de 18 anos, CNH válida (provisória ou definitiva), ter cartão crédito em seu nome (com limite disponível para pré-autorização) e ser aprovado na análise cadastral da Localiza. Caso você tenha entre 18 e 20 anos será necessário adicionar o Condutor Jovem em sua reserva.
          </p>
          <p>
          ...
          <p>
            Para a modalidade Aluguel Mensal, é necessário realizar o Depósito de Segurança, que deve ser pago na abertura do contrato com valor equivalente a UMA mensalidade. Este valor serve como garantia do aluguel e quaisquer encargos envolvidos na locação, podendo ser utilizado para compensar débitos com a Localiza. No fechamento do contrato, caso não haja débitos pendentes, a Localiza realizará o estorno no cartão de crédito ou o reembolso em conta bancária nacional cadastrada.
          </p>
          <p>
          ...
          <p>
            Na falta do grupo reservado, você poderá ser atendido com carro de categoria superior ou inferior até que a Localiza disponibilize o modelo reservado inicialmente, para que você realize a substituição.
          </p>
          <p>
          ...
          <p>
            O carro alugado pode ser devolvido em qualquer agência Localiza, mediante cobrança da taxa de retorno. A cobrança varia conforme cidade, grupo de carro reservado e distância entre a agência de retirada e de devolução (valores disponíveis nas agências Localiza).
          </p>
          <p>
          ...
          <p>
            Em caso de furto, roubo, incêndio e colisão, é obrigatória a apresentação do Boletim de Ocorrência e o preenchimento do Relatório de Avarias/Aviso de Sinistro, na Localiza.
          </p>
          <p>
          ...
          <p>
            A TAXA DE ALUGUEL de 15% refere-se ao percentual aplicado sobre o valor total do contrato, inclusive sobre o CUSTO PREFIXADO DE LIMITE DE DANOS. Ela incidirá sobre o valor total de cada fatura emitida pela Localiza.
          </p>
          <p>
          ...
          <p className="font-semibold">OBRIGADO POR ESCOLHER A LOCALIZA!</p>
        </div>
      </DialogContent>
    </Dialog>
  );
